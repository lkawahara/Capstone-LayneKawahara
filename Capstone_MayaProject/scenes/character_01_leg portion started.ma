...
//Name: character_01_leg portion started.ma
//Last modified: Tue, Sep 30, 2014 11:49:37 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.8573307029926989 0.072038343619444001 24.193726534880138 ;
	setAttr ".r" -type "double3" -4.1999999999999096 5.2000000000005651 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.005796776355062;
...
createNode transform -s -n "front";
	setAttr ".t" -type "double3" 2.5579515598687768 -2.3820087309756897 106.66422874216933 ;
createNode camera -s -n "frontShape" -p "front";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 17.739477493587415;
...
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	...
	setAttr -s 8 ".pt[121:128]" -type "float3"  0 -2.6645689 0.067476168 
		0 -2.729461 0.067476161 0 -2.7700183 0.067476168 0 -3.0620313 0.067476079 0 -3.0620308 
		0.067476168 0.25788262 -2.7725551 0.067476153 0.25788254 -2.7725551 0.067476183 0 
		-3.0620308 0.067476235;
	setAttr ".dr" 1;
...
createNode polySplit -n "polySplit21";
	setAttr -s 3 ".e[0:2]"  1 0.23799551 0.21965945;
	setAttr -s 3 ".d[0:2]"  -2147483564 -2147483511 -2147483512;
createNode polySplit -n "polySplit22";
	setAttr -s 2 ".e[0:1]"  1 0.55691308;
	setAttr -s 2 ".d[0:1]"  -2147483563 -2147483510;
createNode polySplit -n "polySplit23";
	setAttr -s 2 ".e[0:1]"  0 0.58096892;
	setAttr -s 2 ".d[0:1]"  -2147483506 -2147483508;
createNode polySplitRing -n "polySplitRing34";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 18 "e[40]" "e[49]" "e[58]" "e[63]" "e[65:72]" "e[78]" "e[81:82]" "e[86]" "e[94]" "e[102]" "e[105]" "e[113]" "e[116]" "e[124]" "e[127]" "e[135]" "e[141]" "e[145]";
	setAttr ".ix" -type "matrix" 0.65164270013854619 0 0 0 0 0.90708464495165964 0 0
		 0 0 1.0099334725401963 0 0.039147893225329133 6.5571417832183361 0 1;
	setAttr ".wt" 0.87767809629440308;
	setAttr ".dr" no;
	setAttr ".re" 82;
	setAttr ".sma" 29.999999999999996;
	setAttr ".p[0]"  0 0 1;
...
createNode polyTweak -n "polyTweak73";
	setAttr ".uopa" yes;
	setAttr -s 7 ".tk";
	setAttr ".tk[77]" -type "float3" 0 -0.28331676 0 ;
	setAttr ".tk[78]" -type "float3" 0 -0.70316023 0 ;
	setAttr ".tk[79]" -type "float3" 0 -0.34217128 0 ;
	setAttr ".tk[80]" -type "float3" 0 -0.63606167 0 ;
createNode polyTweak -n "polyTweak74";
	setAttr ".uopa" yes;
	setAttr -s 10 ".tk";
	setAttr ".tk[47]" -type "float3" 0 -0.09901911 0 ;
	setAttr ".tk[52]" -type "float3" 0 -0.09901911 0 ;
	setAttr ".tk[92]" -type "float3" 0 -0.09901911 0 ;
	setAttr ".tk[93]" -type "float3" -0.011879762 -0.1394186 0 ;
	setAttr ".tk[94]" -type "float3" -0.011879762 -0.16719723 0 ;
	setAttr ".tk[95]" -type "float3" 0 -0.09901911 0 ;
createNode deleteComponent -n "deleteComponent36";
	setAttr ".dc" -type "componentList" 1 "f[59:64]";
createNode polyExtrudeEdge -n "polyExtrudeEdge20";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 3 "e[82:85]" "e[163]" "e[165:167]";
	setAttr ".ix" -type "matrix" 0.65164270013854619 0 0 0 0 0.90708464495165964 0 0
		 0 0 1.0099334725401963 0 0.039147893225329133 6.5571417832183361 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 0.91900992 -0.15703492 0.087899983 ;
	setAttr ".rs" 63824;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 0.11841622411377489 -0.86156087279653804 -1.2828760222926949 ;
	setAttr ".cbx" -type "double3" 1.7196035981389817 0.54749104217640987 1.4586759852668696 ;
createNode polyExtrudeEdge -n "polyExtrudeEdge21";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 7 "e[192]" "e[194]" "e[196]" "e[198]" "e[200]" "e[202]" "e[204:205]";
	setAttr ".ix" -type "matrix" 0.65164270013854619 0 0 0 0 0.90708464495165964 0 0
		 0 0 1.0099334725401963 0 0.039147893225329133 6.5571417832183361 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 1.209672 -0.59461206 -0.062995814 ;
	setAttr ".rs" 46924;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 0.2913985178023884 -0.97077857829783376 -1.2573512861926508 ;
	setAttr ".cbx" -type "double3" 2.1279454594354781 -0.21844554474842326 1.1313596593244215 ;
createNode polyTweak -n "polyTweak75";
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[105]" -type "float3" 0.73903263 -0.83658528 -0.27344355 ;
	setAttr ".tk[106]" -type "float3" 0.93167996 -0.42816985 -0.32409689 ;
	setAttr ".tk[107]" -type "float3" 0.62663448 -0.84222472 -0.18685767 ;
	setAttr ".tk[108]" -type "float3" 0.66296375 -0.84439355 -0.11113956 ;
	setAttr ".tk[109]" -type "float3" 0.83054209 -0.79892504 -0.016904987 ;
	setAttr ".tk[110]" -type "float3" 0.24321935 -0.12040485 -0.24677896 ;
	setAttr ".tk[111]" -type "float3" 0.24797019 -0.12040485 -0.089300051 ;
	setAttr ".tk[112]" -type "float3" 0.94287515 -0.42108688 0.025273733 ;
createNode polyExtrudeEdge -n "polyExtrudeEdge22";
	setAttr ".uopa" yes;
	setAttr ".ics" -type "componentList" 7 "e[208]" "e[210]" "e[212]" "e[214]" "e[216]" "e[218]" "e[220:221]";
	setAttr ".ix" -type "matrix" 0.65164270013854619 0 0 0 0 0.90708464495165964 0 0
		 0 0 1.0099334725401963 0 0.039147893225329133 6.5571417832183361 0 1;
	setAttr ".ws" yes;
	setAttr ".pvt" -type "float3" 1.2216798 -0.99555659 -0.062995814 ;
	setAttr ".rs" 40613;
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 0.22588798476685812 -1.2990277234351932 -1.3238306239565725 ;
	setAttr ".cbx" -type "double3" 2.2174716318247554 -0.69208545100820373 1.1978389970883432 ;
createNode polyTweak -n "polyTweak76";
	setAttr ".uopa" yes;
	setAttr -s 12 ".tk";
	setAttr ".tk[77]" -type "float3" 0 -0.047642302 0 ;
	setAttr ".tk[78]" -type "float3" 0 -0.047642302 0 ;
	setAttr ".tk[91]" -type "float3" 0 -0.047642302 0 ;
	setAttr ".tk[92]" -type "float3" 0 -0.047642302 0 ;
	setAttr ".tk[113]" -type "float3" 0.09503141 -0.52509928 0.046738092 ;
	setAttr ".tk[114]" -type "float3" 0.022437245 -0.5462147 0.065825425 ;
	setAttr ".tk[115]" -type "float3" 0.13738528 -0.5229739 0.014110645 ;
	setAttr ".tk[116]" -type "float3" 0.1236958 -0.52215636 -0.014421816 ;
	setAttr ".tk[117]" -type "float3" 0.060548484 -0.53929031 -0.049931515 ;
	setAttr ".tk[118]" -type "float3" -0.13268952 -0.36187264 0.036690246 ;
	setAttr ".tk[119]" -type "float3" -0.10053129 -0.36187264 -0.022651415 ;
	setAttr ".tk[120]" -type "float3" 0.018219326 -0.54888296 -0.065825425 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyExtrudeEdge22.out" "pCylinderShape1.i";
...
connectAttr "polyBridgeEdge6.out" "polySplit21.ip";
connectAttr "polySplit21.out" "polySplit22.ip";
connectAttr "polySplit22.out" "polySplit23.ip";
connectAttr "polyTweak73.out" "polySplitRing34.ip";
connectAttr "pCylinderShape1.wm" "polySplitRing34.mp";
connectAttr "polySplit23.out" "polyTweak73.ip";
connectAttr "polySplitRing34.out" "polyTweak74.ip";
connectAttr "polyTweak74.out" "deleteComponent36.ig";
connectAttr "deleteComponent36.og" "polyExtrudeEdge20.ip";
connectAttr "pCylinderShape1.wm" "polyExtrudeEdge20.mp";
connectAttr "polyTweak75.out" "polyExtrudeEdge21.ip";
connectAttr "pCylinderShape1.wm" "polyExtrudeEdge21.mp";
connectAttr "polyExtrudeEdge20.out" "polyTweak75.ip";
connectAttr "polyTweak76.out" "polyExtrudeEdge22.ip";
connectAttr "pCylinderShape1.wm" "polyExtrudeEdge22.mp";
connectAttr "polyExtrudeEdge21.out" "polyTweak76.ip";
connectAttr "pCylinderShape1.iog" ":initialShadingGroup.dsm" -na;
connectAttr "defaultRenderLayer.msg" ":defaultRenderingList1.r" -na;
// End of character_01_leg portion started.ma
